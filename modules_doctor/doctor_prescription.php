    ...
    <section class="property-form">
        ...
        <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex">
                <div class="box">
                    <p>Full Name</p>
                    <input type="text" name="doctorName" value="Stehpen Jones" class="input"
                        readonly>
                </div>
                <div class="box">
                    <p>License No.</p>
                    <input type="text" name="licenseNumber" value="0053272" class="input"
                        readonly>
                </div>
            </div>
            <!-- 1st LINE -->
            ...
            <div class="flex">
                <div class="box">
                    ...
                    <input type="text" name="patient_name"
                        value="John Cena"
                        placeholder="Patient Name" class="input" readonly>
                </div>

                <div class="box">
                    <p>Gender</p>
                    <input type="text" name="gender" value="Male" placeholder="Patient Gender"
                        class="input" readonly>
                </div>

                <div class="box">
                    <p>Address</p>
                    <input type="text" name="address" value="Nangka, Marikina City" placeholder="Enter Patient Adress"
                        class="input" readonly>
                </div>

                <div class="box">
                    <p>Age</p>
                    <input type="text" name="age" value="21" placeholder="Patient Age"
                        class="input" readonly>
                </div>

                <div class="box">
                    <p>Phone #</p>
                    <input type="text" name="phoneNumber" value="09389380621" placeholder="Patient Number"
                        class="input" readonly>
                </div>
            ...
            <div class="wrapper">
                ...
                <div class="row" name="add_medicine[0]" id="add_medicine" placeholder="Another Field">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <div class="mediv">
                            <select class="select2" id="medicine" name="medicine" required>
                                ...
                                <option value="US">Biogesic</option>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <div class="">
                            <input class="med_quantity" type="number" name="med_quantity" placeholder="Enter Quantity"
                                min="0" max="100" />
                        </div>
                    </div>
                    <!-- -->
                    <div class="col-md-3 mb-3">
                        <div class="form-group">
                            ...
                            <input class="med_instruction" type="text" name="med_instruction"
            ...
            <div class="box">
                ...
                <textarea name="prescription" maxlength="1000" class="input" required cols="30" rows="10"
                    placeholder="Write about the prescription..."></textarea>
            </div>
