<?php 
    ...
    if(isset($_POST['update_profile'])) {
        ...
        if($user_data['password'] != $cpass) {
            ...
            $update_data = "UPDATE doctor SET firstName='$update_firstName', lastName='$update_lastName', birthday='$update_birthday', age='$update_age', sex='$update_sex'  WHERE id = '$id'";
            mysqli_query($con, $update_data);
			header("Location: doctor_profile_pi.php");
        }
    };
?>
        ...
        <div class="container">
            <div class="admin-product-form-container">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <a href="doctor_profile_pi.php" class="btn">go back!</a>
                </form>
