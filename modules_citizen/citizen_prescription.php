...
<body>
    ...
    <div class="row justify-content-center">
        ...
        <!-- col for the form -->
        <div class="col-md-8 shadow p-5 mb-5 bg-white rounded">
            <br>
            <br>
            <div class="container">
                <div class="row">
            ...
            <div class="container mt-5">
                ...
                <h1 class="rx_title"><img class="rx_logo" src="../img/rx-logo.png" alt="">List of Prescriped Medication
                </h1>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="text" scope="col">Medication Name</th>
                            <th class="text" scope="col">Purpose</th>
                            <th class="text" scope="col">Dosage</th>
                            <th class="text" scope="col">Frequency</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
            ...
            <div class="prescription-footer p-3 mb-2">
                <div class="row">
                    ...
                    <div class="col ">
                        <p class="info text-center"><i class="info fas fa-envelope me-3"></i> nangka.health.center@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
