    ...
    if(isset($_POST['update_product'])) {
        ...
        if(empty($product_name) || empty($product_image)) {
            ...
            if($upload) {
                ...
                $error_msg[] = 'could not add the Family';
            }
        }
    };
?>
...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <section class="dashboard">
            <h1 class="heading">Update Family</h1>
        </section>
        ...
        <div class="container">
            <div class="admin-product-form-container">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <h3 class="title">update the Family</h3>
                    <input type="text" class="box" name="product_name" value="<?php echo $row['name']; ?>" placeholder="enter Family Number">
                    <input type="file" class="box" name="product_image"  accept="image/png, image/jpeg, image/jpg">
                    <input type="submit" value="update Family" name="update_product" class="btn">
