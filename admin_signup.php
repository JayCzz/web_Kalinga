        ...
        <div class="container">
            ...
            <form action="action/signup.php" method="post">
                <div class="main-user-info">
                    ...
                    <div class="user-input-box">
                        <label for="adminNumber">ID Number</label>
                        <input type="text" id="adminNumber" name="adminNumber" placeholder="Enter ID Number" required/>
                    </div>
                ...
                <div class="form-submit-btn">
                    <input id="button" type="submit" name="admin_signup" value="Register">
                </div>
                
                <div class="signup-link">Already have an account? <a href="admin_login.php">Login here</a></div>
            </form>
        </div>
